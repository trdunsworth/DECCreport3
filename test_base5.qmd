...
# Prefer vroom for faster CSV loading when available; fallback to readr
df <- tryCatch({
...
# Ensure cache invalidates when the source CSV changes
try({ knitr::opts_current$set(cache.extra = file.info(data_file)$mtime) }, silent = TRUE)
```
