...
barProblem_APD <- problem_counts_APD |>
    ggplot(aes(x = reorder(Problem, -n), y = n, fill = Problem)) +
    geom_bar(stat = "identity") +
    paletteer::scale_fill_paletteer_d("cartography::blue.pal", dynamic = TRUE, name = "Problem") +
    labs(
...
barDOW_AFD <- df_fire |> ggplot(aes(x = DOW, fill = DOW)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::red.pal", dynamic = TRUE, name = "Day of Week") +
    labs(
...
barReception_AFD <- df_fire |> ggplot(aes(x = Call_Reception, fill = Call_Reception)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::red.pal", dynamic = TRUE, name = "Call Reception") +
    labs(
...
barProblem_AFD <- problem_counts_AFD |>
    ggplot(aes(x = reorder(Problem, -n), y = n, fill = Problem)) +
    geom_bar(stat = "identity") +
    paletteer::scale_fill_paletteer_d("cartography::red.pal", dynamic = TRUE, name = "Problem") +
    labs(
...
barPriority_AFD <- df_fire |> ggplot(aes(x = Priority_Number, fill = Priority_Number)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::red.pal", dynamic = TRUE) +
    labs(
        title = "Number of Calls for Service by Priority Level",
        x = "Priority Level",
        y = "Number of Calls"
...
barDOW_EMS <- df_ems |> ggplot(aes(x = DOW, fill = DOW)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::green.pal", dynamic = TRUE, name = "Day of Week") +
    labs(
...
barReception_EMS <- df_ems |> ggplot(aes(x = Call_Reception, fill = Call_Reception)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::green.pal", dynamic = TRUE, name = "Call Reception") +
    labs(
...
barProblem_EMS <- problem_counts_EMS |>
    ggplot(aes(x = reorder(Problem, -n), y = n, fill = Problem)) +
    geom_bar(stat = "identity") +
    paletteer::scale_fill_paletteer_d("cartography::green.pal", dynamic = TRUE, name = "Problem") +
    labs(
...
barPriority_EMS <- df_ems |> ggplot(aes(x = Priority_Number, fill = Priority_Number)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::green.pal", dynamic = TRUE) +
    labs(
        title = "Number of Calls for Service by Priority Level",
        x = "Priority Level",
        y = "Number of Calls"
...
barDOW_911 <- df_911 |> ggplot(aes(x = DOW, fill = DOW)) +
    geom_bar() +
    paletteer::scale_fill_paletteer_d("cartography::blue.pal", dynamic = TRUE, name = "Day of Week") +
    labs(
        title = "Number of Calls for Service for EMS by Day of the Week",
        x = "Day of the Week",
        y = "Number of Calls"
