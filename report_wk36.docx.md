...
As expected, the vast majority of medical calls arrive via 911 trunk lines. However, 10.2 percent of medical calls arrived without a method by which we recevied the call.
