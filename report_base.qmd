...
Most of the calls arrived by `r busiest_cr`. 911 trunk line calls were `r e911_percentage` percent of all calls. There were `r not_captured_count` calls where we did not indicated how the service call was received. Since this is only `r not_captured_percentage` percent of the total number of calls, this may be something to watch over time.
