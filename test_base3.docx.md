...
```
✓ paletteer package loaded successfully
```
...
::: {.cell}
::: {.cell-output-display}
![Prevalence of missing values. Only columns with missing data are shown.](test_base3_files/figure-docx/missing-values-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by day of the week.](test_base3_files/figure-docx/day-of-week-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by hour of the day.](test_base3_files/figure-docx/hour-of-day-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by shift.](test_base3_files/figure-docx/shifts-1.png)
:::

::: {.cell-output-display}
![Number of calls for service by shift.](test_base3_files/figure-docx/shifts-2.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by priority level.](test_base3_files/figure-docx/priority-level-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by discipline.](test_base3_files/figure-docx/discipline-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call reception.](test_base3_files/figure-docx/call-reception-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call type.](test_base3_files/figure-docx/call-type-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by telecommunicator.](test_base3_files/figure-docx/telecommunicator-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Call Volume by Hour and Day of Week](test_base3_files/figure-docx/hour-dow-analysis-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Ridge Plot Alternative - Calls per Hour by Day of Week](test_base3_files/figure-docx/alternative-ridge-plot-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](test_base3_files/figure-docx/ttq-plots-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-1.png)
:::

::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-2.png)
:::

::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-3.png)
:::

::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-4.png)
:::

::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-5.png)
:::

::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-plots-6.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![](test_base3_files/figure-docx/elapsed-time-grid-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by day of the week.](test_base3_files/figure-docx/apd-day-of-week-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by hour of the day.](test_base3_files/figure-docx/apd-hour-of-day-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call reception.](test_base3_files/figure-docx/apd-call-reception-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call type.](test_base3_files/figure-docx/apd-call-type-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by priority level.](test_base3_files/figure-docx/apd-priority-level-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by day of the week.](test_base3_files/figure-docx/afd-day-of-week-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by hour of the day.](test_base3_files/figure-docx/afd-hour-of-day-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call reception.](test_base3_files/figure-docx/afd-call-reception-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call type.](test_base3_files/figure-docx/afd-call-type-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by priority level.](test_base3_files/figure-docx/afd-priority-level-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by day of the week.](test_base3_files/figure-docx/ems-day-of-week-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by hour of the day.](test_base3_files/figure-docx/ems-hour-of-day-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call reception.](test_base3_files/figure-docx/ems-call-reception-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call type.](test_base3_files/figure-docx/ems-call-type-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by priority level.](test_base3_files/figure-docx/ems-priority-level-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Top High-Priority Call Types](test_base3_files/figure-docx/hp-call-types-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![High-Priority Call Response Times](test_base3_files/figure-docx/hp-response-times-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Cardiac Arrest Call Volume by Day and Hour](test_base3_files/figure-docx/ca-call-volume-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by day of the week.](test_base3_files/figure-docx/mh-day-of-week-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by hour of the day.](test_base3_files/figure-docx/mh-hour-of-day-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call reception.](test_base3_files/figure-docx/mh-call-reception-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by call type.](test_base3_files/figure-docx/mh-call-type-1.png)
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Number of calls for service by priority level.](test_base3_files/figure-docx/mh-priority-level-1.png)
:::
:::
